...
ATTR_PURE__ static inline unsigned int spolyvec4_chknorm(const spolyvec4 *v,
							 int32_t bound)
{
	unsigned int i;
...
ATTR_PURE__ static inline unsigned int spolyvec5_chknorm(const spolyvec5 *v,
							 int32_t bound)
{
	unsigned int i;
...
ATTR_PURE__ static inline unsigned int spolyvec7_chknorm(const spolyvec7 *v,
							 int32_t bound)
{
	unsigned int i;
